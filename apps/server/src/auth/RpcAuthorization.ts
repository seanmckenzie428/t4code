...
export const RPC_REQUIRED_SCOPES = {
  ...
  [WS_METHODS.projectsSaveAppView]: AuthOrchestrationOperateScope,
  ...
  [WS_METHODS.reviewGetWorkingTreeFileContents]: AuthReviewWriteScope,
  ...
  [WS_METHODS.appControlConnect]: AuthOrchestrationOperateScope,
  [WS_METHODS.appControlRespond]: AuthOrchestrationOperateScope,
  [WS_METHODS.appControlFocusHost]: AuthOrchestrationOperateScope,
  [WS_METHODS.appControlInvokeServer]: AuthOrchestrationOperateScope,
