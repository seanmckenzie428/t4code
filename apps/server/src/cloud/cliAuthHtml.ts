...
<html lang="en">
  <head>
    ...
    <title>T4 Connect authorization complete</title>
    <style>
      :root {
  ...
  <body>
    <main>
      ...
      <section class="content">
        ...
        <p class="description">Return to your terminal to finish setting up T4 Connect. You can close this window.</p>
      </section>
    </main>
  </body>
</html>`;
